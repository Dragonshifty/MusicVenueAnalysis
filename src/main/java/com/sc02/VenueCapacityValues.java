...
public class VenueCapacityValues {
    ...
    static{
        venueCapacities.put("O2 Academy Birmingham", 3009);
        venueCapacities.put("O2 Academy2 Birmingham", 600);
        venueCapacities.put("O2 Academy3 Birmingham", 250);
        ...
        venueCapacities.put("O2 Academy2 Islington", 250);
        venueCapacities.put("O2 Academy Leeds", 2300);
        venueCapacities.put("O2 Academy Leicester", 1450);
        venueCapacities.put("O2 Academy2 Leicester", 500);
        venueCapacities.put("O2 Academy3 Leicester", 250);
        venueCapacities.put("O2 Academy Liverpool", 1200);
        venueCapacities.put("Mountford Hall, Liverpool Guild of Students", 2300);
        venueCapacities.put("O2 Academy2 Liverpool", 500);
        venueCapacities.put("O2 Academy Oxford", 1020);
        venueCapacities.put("O2 Academy2 Oxford", 436);
        venueCapacities.put("O2 Academy Sheffield", 2350);
        venueCapacities.put("O2 Academy2 Sheffield", 500);
        ...
        venueCapacities.put("O2 Institute2 Birmingham", 600);
        venueCapacities.put("O2 Institute3 Birmingham", 250);
